	...
	<nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="/EventManagement/home" class="navbar-brand">Event
					Management</a>
			</div>
			<div class="navbar-header">
				...
				<div class="container">
					<div class="jumbotron col-sm-12">
						...
						<div class="col-lg-9">
							...
							<form:button class="btn btn-success col-lg-offset-11 btn-lg"
								id="join">
								<span class="glyphicon glyphicon-plus"></span> Join </form:button>
						</div>
					</div>
				</div>
			</div>
